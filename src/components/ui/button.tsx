  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 hover:scale-105 shadow-xl shadow-primary/30 font-semibold",
        "hero-outline": "border-2 border-primary/40 bg-card/50 backdrop-blur-sm text-primary hover:bg-card/70 hover:border-primary/60 font-semibold",
        mood: "bg-gradient-to-r from-lavender to-sky text-foreground hover:shadow-lg hover:scale-105 font-medium",
      },
      size: {
